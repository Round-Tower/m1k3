...
def download_models():
    ...
    models_to_download = [
        ...
        },
        {
            ...
            "source": "direct",
            "url": "https://huggingface.co/HuggingFaceTB/SmolLM-135M-GGUF/resolve/main/SmolLM-135M.Q4_K_M.gguf",
            "filename": "SmolLM-135M.Q4_K_M.gguf",
            "description": "SmolLM2 135M quantized GGUF model - lightweight and efficient",
            "required": True
        }
    ]
