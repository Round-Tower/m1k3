...
class KokoroTextEncoder: Module {
    ...
    func callAsFunction(_ x: MLXArray, inputLengths _: MLXArray, mask: MLXArray) -> MLXArray {
        var h = embedding(x)
...
class KokoroDurationEncoder: Module {
    ...
    init(styDim: Int, dModel: Int, nLayers: Int, dropout _: Float = 0.1) {
        self.dModel = dModel
        self.styDim = styDim
    ...
    func callAsFunction(_ x: MLXArray, style: MLXArray, textLengths _: MLXArray, mask: MLXArray) -> MLXArray {
