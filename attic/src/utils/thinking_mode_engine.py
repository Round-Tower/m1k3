...
from src.utils.thinking_parser import ThinkingFlow as ThinkingAnalysis  # Use unified structure
...
# ThinkingAnalysis is now imported as alias for ThinkingFlow from src.utils.thinking_parser
